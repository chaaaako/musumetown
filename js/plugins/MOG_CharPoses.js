 ...
 * ANIMATION SPEED
 * ===========================================================================
 * Essa funﾃｧﾃ｣o permite regular a velocidade da animaﾃｧﾃ｣o.
 *
 ...
 * ===========================================================================
 * Essa funﾃｧﾃ｣o permite ajustar a posiﾃｧﾃ｣o X e Y da imagem do character.
 *
 ...
 * HISTﾃ迭ICO
 * ===========================================================================
 * (v2.1) - Correﾃｧﾃ｣o do bug da funﾃｧﾃ｣o adicionar e remover personagem.
 *        - Correﾃｧﾃ｣o do Lag em mapas com muitos eventos.
 * (v2.0) - Compatibilidade com Chrono Engine.
 *        - Sistema de pre cache.
 *        - Multi Frames.
 *        - Opﾃｧﾃ｣o de definir X-offset & Y-offset;
 *        - Correﾃｧﾃ｣o de nﾃ｣o ativar a pose apﾃｳs o personagem ser inserido.
 */
/*:ja
 * @plugindesc (v2.1) アクターにマップ移動中のポーズを追加します。
 * @author Moghunter
 *
 * @param Poses for Followers
 * @type boolean
 ...
 * https://atelierrgss.wordpress.com/
 * ===========================================================================
 * アクターにマップ移動中のポーズを追加します。
 * (停止 / ダッシュ / ジャンプ)
 *
 * ===========================================================================
 * 必要な画像ファイル
 * ===========================================================================
 * 必要な画像ファイルを下記フォルダーに保存してください。
 * /img/characters/
 * ポーズの画像は次のように記録する必要があります。
 *
 * FILE_NAME - アクターの通常の歩行キャラのファイル名
 * 例
 * $Magica02.png
 *
 * (停止ポーズ)
 ...
 * 複数フレーム
 * ===========================================================================
 * アクター画像で複数のフレームを有効にするには、
 * 以下のようにアクター画像に名前を付けます。
 *
 * FILENAME(F + Number_of_Frames)
 *
 * 例
 ...
 * ===========================================================================
 *
 * - 下記コマンドで、ゲーム中にポーズを有効にします。
 *
 * enable_charposes
 *
 * - 下記コマンドで、プレイ中にポーズを無効にします。
 *
 * disable_charposes
 *
 * ===========================================================================
 * 更新履歴
 * ===========================================================================
 * (v2.1) - アクター機能の追加と削除のバグ修正
 *        - 多くのイベントがあるマップのラグ補正
 * (v2.0) - クロノエンジンの互換性
 *        - 事前キャッシュシステム追加
 *        - マルチフレーム追加
 *        - XオフセットとYオフセットを設定するオプション追加
 *        - アクターが挿入された後にポーズをアクティブにしない問題を修正
 */
