 ...
 * - REMOVER CLIMA
 * ============================================================================
 * 天候を削除するには、下記のプラグインコマンドを使用してください。
 *
 *      clear_weather : WEATHER_INDEX
 *
 * 全ての天候を削除するには、以下のプラグインコマンドを使用してください。
 *
 *      clear_all_weathers
 *
 * 戦闘の天候を無効にするには、以下のプラグインコマンドを使用してください。
 *
 *      battle_weather : false
 *
 * ============================================================================
 ...
 *  
 * - (version 3.2) -
 *   (BUG FIX) - MOG_BattleCameraFrontalプラグインでのFog XP Style効果のバグを修正
 *
 * - (version 3.1) -
