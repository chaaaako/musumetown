 ...
 * @requiredAssets audio/me/Applause1
 * @requiredAssets audio/se/Cursor3
 *
 * @help
 * Plugin Command:
    ...
    switch (this._status) {
        ...
        case SLTReelSprite.STOPPING:
            ...
            if (this._scrollY > this._winSpot * this._spotHeight) {
                ...
                AudioManager.playSe({ "name": "Cursor3", "volume": 90, "pitch": 100, "pan": 0 });
            }
            this.setFrame(
                0,
                this._spotHeight * this._numSpot * 2 - this._scrollY - this._spotHeight * 2,
...
Scene_SlotMachine.prototype.result = function () {
    ...
    if (this._winCoin > 0) {
        ...
        AudioManager.playMe({ "name": "Applause1", "volume": 90, "pitch": 100, "pan": 0 });
    }
    else {
